...
function computeMixScore(technicalData, genreRef = null) {
    try {
        console.log('[SCORING_V4] 🔥 NOVO SISTEMA DE PENALIDADES BALANCEADAS ATIVO!');
        console.log('[SCORING_V4] 📥 Entrada - technicalData:', !!technicalData);
        console.log('[SCORING_V4] 📥 Entrada - technicalData keys:', technicalData ? Object.keys(technicalData) : 'null');
        console.log('[SCORING_V4] 📥 Entrada - genreRef:', !!genreRef);
        ...
        console.error('[SCORING_V4] ❌ ERRO CRÍTICO na função computeMixScore:', error);
        console.error('[SCORING_V4] ❌ Stack trace:', error.stack);
        return { scorePct: 30, classification: 'Básico', breakdown: {}, note: 'Erro no sistema V4: ' + error.message };
    }
}
