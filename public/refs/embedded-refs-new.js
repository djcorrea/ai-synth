...
(function(){
  ...
  window.__EMBEDDED_REFS__.byGenre['funk_mandela'] = {
    version: "2025-08-mandela-targets.5-spectral-percent-rebuild-rebuild", 
    aggregation_method: "linear_domain",
    num_tracks: 17,
    lufs_target: -5, tol_lufs: 2.5,
    true_peak_target: -2.9, tol_true_peak: 3.4,
    dr_target: 7.2, tol_dr: 3,
    lra_target: 9.2, tol_lra: 2.5,
    stereo_target: 0.52, tol_stereo: 0.25,
    calor_target: -8.42, brilho_target: -14.83, clareza_target: -0.35,
    bands: {
      sub: { target_db: -5.7, tol_db: 2.5 },
      low_bass: { target_db: -6.1, tol_db: 2.5 },
      upper_bass: { target_db: -8.8, tol_db: 2.5 },
      low_mid: { target_db: -5.4, tol_db: 2.5 },
      mid: { target_db: -3.3, tol_db: 2.5 },
      high_mid: { target_db: -7.5, tol_db: 2.5 },
      brilho: { target_db: -11.6, tol_db: 2.5 },
      presenca: { target_db: -14.3, tol_db: 2.5 }
    }
  };
  window.__EMBEDDED_REFS__.byGenre['funk_bruxaria']  = {
    version: "2025-08-mandela-targets.5-spectral-percent-rebuild-rebuild",
    generated_at: "2025-08-25T01:33:39.971Z",
    num_tracks: 29,
    lufs_target: -5.1,
    tol_lufs: 3,
    true_peak_target: -2.2,
    tol_true_peak: 2.5,
    dr_target: 7.8,
    tol_dr: 5,
    lra_target: 8.4,
